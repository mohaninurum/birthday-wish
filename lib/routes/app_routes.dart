  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    type: PageTransitionType.leftToRight, duration: const Duration(milliseconds: 500), settings: settings);
      case AppRoutesName.homeScreen:
        ...
        return PageTransition(child: EditorScreen(), type: PageTransitionType.leftToRight, alignment: Alignment.center, duration: const Duration(milliseconds: 500), settings: settings);
      // case AppRoutesName.frameEditorScreen:
